...
from dots_python_sdk.model.paymentcustomers_list_all_response import PaymentcustomersListAllResponse as PaymentcustomersListAllResponseSchema

from dots_python_sdk.type.paymentcustomers_list_all_response import PaymentcustomersListAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.paymentcustomers_list_all_response import PaymentcustomersListAllResponse as PaymentcustomersListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PaymentcustomersListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PaymentcustomersListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PaymentcustomersListAllResponsePydantic:
        ...
        if validate:
            return PaymentcustomersListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PaymentcustomersListAllResponsePydantic, raw_response.body)
