...
from dots_python_sdk.model.transferbatches_list_all_response import TransferbatchesListAllResponse as TransferbatchesListAllResponseSchema

from dots_python_sdk.type.transferbatches_list_all_response import TransferbatchesListAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.transferbatches_list_all_response import TransferbatchesListAllResponse as TransferbatchesListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TransferbatchesListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransferbatchesListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransferbatchesListAllResponsePydantic:
        ...
        if validate:
            return TransferbatchesListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransferbatchesListAllResponsePydantic, raw_response.body)
