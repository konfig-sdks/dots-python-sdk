...
from dots_python_sdk.model.dispute import Dispute as DisputeSchema

from dots_python_sdk.type.dispute import Dispute

from ...api_client import Dictionary
from dots_python_sdk.pydantic.dispute import Dispute as DisputePydantic
...
SchemaFor200ResponseBodyApplicationJson = DisputeSchema
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return DisputePydantic(**raw_response.body)
        return api_client.construct_model_instance(DisputePydantic, raw_response.body)
