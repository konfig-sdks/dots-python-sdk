...
from dots_python_sdk.model.transfers_list_all_response import TransfersListAllResponse as TransfersListAllResponseSchema

from dots_python_sdk.type.transfers_list_all_response import TransfersListAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.transfers_list_all_response import TransfersListAllResponse as TransfersListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TransfersListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransfersListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransfersListAllResponsePydantic:
        ...
        if validate:
            return TransfersListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransfersListAllResponsePydantic, raw_response.body)
