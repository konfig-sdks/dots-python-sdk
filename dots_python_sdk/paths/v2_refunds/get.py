...
from dots_python_sdk.model.refunds_get_all_response import RefundsGetAllResponse as RefundsGetAllResponseSchema

from dots_python_sdk.type.refunds_get_all_response import RefundsGetAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.refunds_get_all_response import RefundsGetAllResponse as RefundsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = RefundsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RefundsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return RefundsGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RefundsGetAllResponsePydantic, raw_response.body)
