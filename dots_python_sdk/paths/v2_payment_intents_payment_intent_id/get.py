...
from dots_python_sdk.model.paymentintents_get_by_id_response import PaymentintentsGetByIdResponse as PaymentintentsGetByIdResponseSchema

from dots_python_sdk.type.paymentintents_get_by_id_response import PaymentintentsGetByIdResponse
...
from dots_python_sdk.pydantic.paymentintents_get_by_id_response import PaymentintentsGetByIdResponse as PaymentintentsGetByIdResponsePydantic
...
SchemaFor404ResponseBodyApplicationJson = PaymentintentsGetByIdResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: PaymentintentsGetByIdResponse
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/payment-intents/{payment_intent_id}',
            auth_settings=_auth,
            headers=_headers,
        )
