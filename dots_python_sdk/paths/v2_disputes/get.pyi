...
from dots_python_sdk.model.disputes_get_all_response import DisputesGetAllResponse as DisputesGetAllResponseSchema

from dots_python_sdk.type.disputes_get_all_response import DisputesGetAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.disputes_get_all_response import DisputesGetAllResponse as DisputesGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DisputesGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DisputesGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DisputesGetAllResponsePydantic:
        ...
        if validate:
            return DisputesGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DisputesGetAllResponsePydantic, raw_response.body)
