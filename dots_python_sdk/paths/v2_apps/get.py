...
from dots_python_sdk.model.apps_list_all_response import AppsListAllResponse as AppsListAllResponseSchema

from dots_python_sdk.type.apps_list_all_response import AppsListAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.apps_list_all_response import AppsListAllResponse as AppsListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AppsListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AppsListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[AppsListAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AppsListAllResponsePydantic, raw_response.body)
