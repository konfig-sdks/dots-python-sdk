...
from dots_python_sdk.model.flows_list_all_response import FlowsListAllResponse as FlowsListAllResponseSchema

from dots_python_sdk.type.flows_list_all_response import FlowsListAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.flows_list_all_response import FlowsListAllResponse as FlowsListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FlowsListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FlowsListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return FlowsListAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FlowsListAllResponsePydantic, raw_response.body)
