...
from dots_python_sdk.model.transaction import Transaction as TransactionSchema

from dots_python_sdk.type.transaction import Transaction

from ...api_client import Dictionary
from dots_python_sdk.pydantic.transaction import Transaction as TransactionPydantic
...
SchemaFor200ResponseBodyApplicationJson = TransactionSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/transactions/{transaction_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return TransactionPydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionPydantic, raw_response.body)
