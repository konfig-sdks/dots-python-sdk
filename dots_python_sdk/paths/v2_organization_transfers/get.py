...
from dots_python_sdk.model.transfers_get_all_response import TransfersGetAllResponse as TransfersGetAllResponseSchema

from dots_python_sdk.type.transfers_get_all_response import TransfersGetAllResponse

from ...api_client import Dictionary
from dots_python_sdk.pydantic.transfers_get_all_response import TransfersGetAllResponse as TransfersGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TransfersGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransfersGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransfersGetAllResponsePydantic:
        ...
        if validate:
            return TransfersGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransfersGetAllResponsePydantic, raw_response.body)
