...
class PaymentmethodsListAllPaymentCustomerResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PaymentMethod']:
                        return PaymentMethod
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PaymentMethod'], typing.List['PaymentMethod']],
                ...
                def __getitem__(self, i: int) -> 'PaymentMethod':
