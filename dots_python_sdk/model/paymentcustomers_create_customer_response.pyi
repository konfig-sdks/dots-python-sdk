...
class PaymentcustomersCreateCustomerResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "user_id", "email", "country_code", "phone_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "user_id", "email", "country_code", "phone_number", ], str]):
