...
class PayoutlinksListAllResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PayoutLink']:
                        return PayoutLink
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PayoutLink'], typing.List['PayoutLink']],
                ...
                def __getitem__(self, i: int) -> 'PayoutLink':
